...
import ioio.rd.vespidrone.PosRotSensors.HeliState;
import ioio.rd.vespidrone.TcpClient.TcpMessageReceiver;

public class MainController implements TcpMessageReceiver
{
    ...
    public int getNWMotorsPowers()
    {
        return uno_varValue;
    }
    public int getNEMotorsPowers()
    {
        return due_varValue;
    }
    public int getSWMotorsPowers()
    {
        return tre_varValue;
    }
    public int getSEMotorsPowers()
    {
        return qua_varValue;
    }
